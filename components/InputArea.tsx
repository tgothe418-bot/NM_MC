  ...
  return (
    <div className="flex flex-col gap-4">
       ...
       <button 
           onClick={onAdvance}
           disabled={isLoading}
           className="w-full py-2 text-xs uppercase tracking-widest text-gray-500 hover:text-indigo-400 border border-transparent hover:border-gray-800 transition-all flex items-center justify-center gap-2"
       >
           <Play className="w-3 h-3" /> Auto-Advance Narrative
       </button>
    </div>
  );
};